...
public class ConsumerExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        props.put(KafkaJsonDeserializerConfig.JSON_VALUE_TYPE, UserInfo.class);
        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord<String, UserInfo> record : records) {
                    ...
                    System.out.printf("Consumed record with key %s and value %s address info %s", key,  value.getName(), value.getAddressinfo() );
                }
            }
        } finally {
            consumer.close();
